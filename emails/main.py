...
I = send_mail(sender= "santusub4u@gmail.com",receiver= "katkuri.santhosh@gmail.com",subject= "Testing for new cloud function to send email",message= "Hi, if you are seeing this ,thats because the cloud function was invoked")
